...
export class Mg1720450297007 implements MigrationInterface {
    name = 'Mg1720450297007'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`service_offers\` (\`service_offer_id\` int NOT NULL AUTO_INCREMENT, \`price\` decimal(5,2) NULL, \`service_type_fk\` int NULL, \`user_fk\` int NOT NULL, PRIMARY KEY (\`service_offer_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`service_offers\` ADD CONSTRAINT \`FK_e42d206122561b4d25687195268\` FOREIGN KEY (\`service_type_fk\`) REFERENCES \`service_types\`(\`service_type_id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`service_offers\` ADD CONSTRAINT \`FK_5eb25ec9c7af62b7c893efe96dc\` FOREIGN KEY (\`user_fk\`) REFERENCES \`users\`(\`user_id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`service_offers\` DROP FOREIGN KEY \`FK_5eb25ec9c7af62b7c893efe96dc\``);
        await queryRunner.query(`ALTER TABLE \`service_offers\` DROP FOREIGN KEY \`FK_e42d206122561b4d25687195268\``);
